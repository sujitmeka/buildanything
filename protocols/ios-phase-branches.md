...
Phase 4 HARD-GATE: iOS mode requires `DESIGN.md` (Pass 1 + Pass 2 complete; broken-refs lint == 0) to exist before Phase 4 starts. If missing or failing lint, return to Phase 3.
